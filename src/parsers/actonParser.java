// Generated from /media/pluto/120637080636EBFB/DDrive/Known/life/uni/Summer2019/Compiler/Projects/Phase3/src/antlr/acton.g4 by ANTLR 4.7.2
package parsers;
		...
		try {
			...
			while (_la==IDENTIFIER) {
				...
				match(SEMICOLON);
				                ...
				                VarDeclaration x  = new VarDeclaration(((ActorDeclarationContext)_localctx).name.id, new ActorType(((ActorDeclarationContext)_localctx).actor.id));
				                x.setLine(((ActorDeclarationContext)_localctx).actor.id.getLine());
				                _localctx.actordec.addKnownActor(x);
